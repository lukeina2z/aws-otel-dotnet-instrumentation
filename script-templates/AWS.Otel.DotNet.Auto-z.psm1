...
$ServiceLocatorVariable = "AWS_OTEL_DOTNET_AUTO_INSTALL_DIR"

function Get-Current-InstallDir() {
    return [System.Environment]::GetEnvironmentVariable($ServiceLocatorVariable, [System.EnvironmentVariableTarget]::Process)
}
...
function Download-OpenTelemetry([string]$Version, [string]$Path) {
    $archive = "aws-distro-opentelemetry-dotnet-instrumentation-windows.zip"
    $dlUrl = "https://github.com/aws-observability/aws-otel-dotnet-instrumentation/releases/download/$Version/$archive"
...
function Download-OpenTelemetry-Install-Module([string]$Version, [string]$Path) {
    $module = "AWS.Otel.DotNet.Auto.psm1"
    $dlUrl = "https://github.com/aws-observability/aws-otel-dotnet-instrumentation/releases/download/$Version/$module"
...
function Get-Environment-Variables-Table([string]$InstallDir, [string]$OTelServiceName) {
    ...
    $vars = @{
        ...
        "OTEL_EXPORTER_OTLP_ENDPOINT"                       = "http://127.0.0.1:4316"
...
function Uninstall-OpenTelemetryCore() {
    ...
    [System.Environment]::SetEnvironmentVariable($ServiceLocatorVariable, $null, [System.EnvironmentVariableTarget]::Process)
}
